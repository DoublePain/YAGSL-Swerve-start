...
public class ElevatorSubsystem extends SubsystemBase
{
  ...
  private final SparkMax        m_motor           = new SparkMax(Constants.IDConstants.Elevator_Left_ID,
                                                                 MotorType.kBrushless);
  private final SparkMax        m_motorRight      = new SparkMax(Constants.IDConstants.Elevator_Right_ID, MotorType.kBrushless);
  ...
  public void simulationPeriodic()
  {
    ...
    Constants.kElevatorCarriage.setPosition(Constants.Coral_Algae_Constants.kAlgaeArmLength, getHeightMeters() + ElevatorConstants.kElevatorUnextendedHeight);
  }
